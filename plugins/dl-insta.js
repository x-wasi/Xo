...
cmd({
    ...
    category: "downloader",
    use: ".ɪɢᴅʟ <ɪɴsᴛᴀɢʀᴀᴍ ᴜʀʟ>",
    filename: __filename
}, async (conn, mek, m, { from, reply, args, q }) => {
    try {
        const url = q || m.quoted?.text;
        if (!url || !url.includes("instagram.com")) {
            return reply("❌ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ/ʀᴇᴘʟʏ ᴛᴏ ᴀɴ ɪɴsᴛᴀɢʀᴀᴍ ʟɪɴᴋ");
        }
...
cmd({
  ...
  try {
    ...
    if (!igUrl || !igUrl.includes("instagram.com")) {
      return reply('Please ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠᴀʟɪᴅ ɪɴsᴛᴀɢʀᴀᴍ ᴜʀʟ. ᴇxᴀᴍᴘʟᴇ: `.ɪɢᴅʟ2 https://instagram.com/...`');
    }
...
cmd({
  ...
  try {
    const igUrl = args[0];
    if (!igUrl || !igUrl.includes("instagram.com")) {
      return reply('❌ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠᴀʟɪᴅ ɪɴsᴛᴀɢʀᴀᴍ ᴠɪᴅᴇᴏ ᴜʀʟ.\n\nExample:\n.igdl5 https://instagram.com/reel/...');
    }
...
async (conn, mek, m, { from, args, q, reply }) => {
    try {
        if (!q) return reply("ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀɴ ɪɴsᴛᴀɢʀᴀᴍ ᴠɪᴅᴇᴏ ʟɪɴᴋ.");
