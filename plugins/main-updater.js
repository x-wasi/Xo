...
cmd({
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ ʏᴏᴜʀ ᴍᴇɢᴀʟᴏᴅᴏɴ ɪs ᴀʟʀᴇᴀᴅʏ ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!");
        }

        await reply("ᴍᴇɢᴀʟᴏᴅᴏɴ-ᴍᴅ ᴜᴘᴅᴀᴛɪɴɢ ᴡᴀɪᴛ ᴘʟs 👨‍💻...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/DybyTech/MEGALODON-MD/archive/main.zip", { responseType: "arraybuffer" });
