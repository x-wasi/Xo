...
cmd({
    ...
    try {
        ...
        if (!isOwner) return reply("*_ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ғᴏʀ ᴛʜᴇ ᴏᴡɴᴇʀ ᴏɴʟʏ_*");
        ...
        await conn.sendMessage(from, {
            ...
            mimetype: 'text/vcard', 
            fileName: 'ᴍᴇɢᴀʟᴏᴅᴏɴ_bot.vcf', 
            caption: `\nᴅᴏɴᴇ sᴀᴠɪɴɢ.\nɢʀᴏᴜᴘ ɴᴀᴍᴇ: *${cmiggc.subject}*\nᴄᴏɴᴛᴀᴄᴛs: *${cmiggc.participants.length}*\n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅʏʙʏ ᴛᴇᴄʜ`}, { quoted: mek });
