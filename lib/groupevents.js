...
┗━━━━━━━━━━━━━━━━━━━━━━━┛`;
                ...
                const raw = setting?.message || defaultWelcome;
                const parsed = format(raw, { user: `@${username}`, group: groupName, count: memberCount, desc: groupDesc, date, time });
                await sendMessage(parsed, true);
            }
...
┗━━━━━━━━━━━━━━━━━━━━━━━┛`;
                ...
                const raw = setting?.message || defaultGoodbye;
                const parsed = format(raw, { user: `@${username}`, group: groupName, count: memberCount, desc: groupDesc, date, time });
                await sendMessage(parsed, true);
            }
